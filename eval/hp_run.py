...
with open(r"C:\Users\likkhian\Desktop\code\officeqa\eval\hp_out.txt","w") as f:
    f.write(f"trend_receipts_2024={trend_r[-1]}\n")
    f.write(f"trend_outlays_2024={trend_o[-1]}\n")
    f.write(f"actual={round(actual_24)}, structural={round(struct_24)}, gap={round(gap_24)}\n")
print("done")
